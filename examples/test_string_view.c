...
int main()
{
    ...
    DCStringView view = dc_val2(dc_sv_create(my_string, 7, 5));
    DCStringView view2 = dc_val2(dc_sv_create(my_string, 0, 5));

    print_sv(&view);
    print_sv(&view2);

    string world = dc_val2(dc_sv_as_cstr(&view));
    string hello = dc_val2(dc_sv_as_cstr(&view2));
